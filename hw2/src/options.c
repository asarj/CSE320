...
void print_short () // MADE CHANGE HERE - added return identifier
...
void print_people () // MADE CHANGE HERE - added return identifier
...
void interactive_rolo () // MADE CHANGE HERE - added return identifier
