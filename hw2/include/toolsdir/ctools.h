...
extern int nbuffconcat();
  ...
  /* to hold the null terminated result.  0 < n < 7 .. */ // MADE CHANGE HERE - fixed comment
...
extern int read_yes_or_no (); // MADE CHANGE HERE - added return type
...
extern int getfile();
  ...
  /* it encounters a line longer than 'maxlinelen' characters. */ // MADE CHANGE HERE - fixed comment
